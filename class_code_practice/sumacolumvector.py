...
def crear_vector():
    vec_caracteres=[0 for i in range (0,MAX)]
    return vec_caracteres

def sumaColum(nf,nc,matriz,vector):
...
def mostrar (matriz,nf,nc,mayor):
    ...
    #Muestro el mayor
    print("\n La suma de los elementos de la matriz es: ",mayor)
...
def main():
    ...
    mayor=sumaColum(nf,nc,matriz)

    #Mostrar resultados
    mostrar(matriz,nf,nc,mayor)
